  ...
  return (
    <section
      ...
      <div
        ...
        data-aos-delay="200"
      >
        <h2 className="text-4xl font-bold mb-4  text-white">{t('cta_cert_company.title')}</h2>
        <p className="text-lg mb-8  text-white">{t('cta_cert_company.description')}</p>

        <Link
          to="/certifications#certification-request-form"
        ...
        >
          <span>{t('cta_cert_company.button')}</span>
