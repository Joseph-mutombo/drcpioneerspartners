  ...
  return (
    <div className="space-y-8 py-10 sm:py-0">
      ...
      >
        ...
        <Link 
          to="/contact"
          className="border-2 border-yellow-500 text-yellow-500 bg-blue-900/20 hover:bg-yellow-500 hover:text-brand-blue px-8 py-2 rounded-lg font-semibold transition-all duration-300"
          >
