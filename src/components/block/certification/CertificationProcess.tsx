  ...
  const steps = [
    {
      ...
      description: 'Inscrivez-vous au programme et passez une évaluation initiale de vos compétences.',
      icon: MessageCircle,
      color: 'bg-blue-100 text-blue-600',
      details: [
        'Remplissage du formulaire d\'inscription',
        'Évaluation de vos compétences actuelles',
        'Définition de vos objectifs de certification',
    ...
    },
    {
      ...
      description: 'Préparez-vous à l\'examen avec nos outils de révision et tests blancs.',
      icon: Target,
    ...
    },
    {
      ...
      description: 'Passez l\'examen officiel et obtenez votre certification reconnue.',
      icon: Award,
      color: 'bg-orange-100 text-orange-600',
      details: [
        'Examen en ligne ou en centre',
        'Évaluation par des experts certifiés',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
        ...
        <div className="text-center mb-16">
          ...
          <p 
            ...
            data-aos-delay="200"
          >
            Découvrez comment nous vous accompagnons étape par étape pour obtenir votre certification 
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="text-3xl font-bold mb-6">
              Pourquoi choisir notre processus de certification ?
            </h3>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8">
              <div className="text-center">
                ...
                <p className="text-white/90">
                  98% de nos candidats obtiennent leur certification grâce à notre accompagnement personnalisé.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-white/90">
                  Rejoignez une communauté de plus de 5000 professionnels certifiés à travers le monde.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-xl font-semibold mb-2">Reconnaissance internationale</h4>
                <p className="text-white/90">
                  Vos certifications sont reconnues dans plus de 50 pays et par les employeurs du monde entier.
                </p>
              </div>
            </div>
